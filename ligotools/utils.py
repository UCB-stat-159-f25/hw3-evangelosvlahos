...
# function that plots the various spectral data
def create_spectral_plots(eventname, strain_L1, strain_L1_whitenbp, strain_H1, strain_H1_whitenbp, fs, dt, ab, bb, normalization, template_p, template_c, template_offset, time, tevent, make_plots, plottype):
